...
Dans notre projet, après une collisions, les deux footbots tirent aléaoirement une nouvelle vitesse inférieure ou égale à la vitesse de base et gardent cette nouvelle vitesse pendant un bref temps après la collision, avant de reprendre leur vitesse originale, ce qui empêche que la collision de se répéter.
\vspace{-1em}
